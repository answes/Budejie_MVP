package com.bigshark.budejie_mvp.pro.business.view.navigation;
 ...
 */
public class BusinessNavigationBuilder extends NavigationBuilderAdapter {
    private ViewPager viewPager;

    public BusinessNavigationBuilder(Context context) {
        super(context);
    }
    ...
    public BusinessNavigationBuilder setUpWithViewPager(ViewPager viewPager) {
